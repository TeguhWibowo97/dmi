...
import 'package:dmi_app/detailproduk_page.dart';
...
class _ProdukPageState extends State<ProdukPage> {
  ...
  Future getPostByCategory() async {
    var response = await http.post(databaseHelper.urlGetProdukByIdKategori,
  ...
  Future getPostByPencarian() async {
    var response = await http.post(databaseHelper.urlGetProdukByPencarian,
