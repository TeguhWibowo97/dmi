...
class _DetailProdukPageState extends State<DetailProdukPage> {
  ...
  Future getPostByIdproduk() async {
    var response = await http.post(databaseHelper.urlGetUlasanByIdProduk,
        body: {"id_produk": widget.list[widget.index]['id'].toString()});
                ...
                Flexible(
                  ...
                  child: Image.network(
                    databaseHelper.serverUrlImage +
                        widget.list[widget.index]['foto_produk'],
                    fit: BoxFit.contain,
